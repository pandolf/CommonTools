...
class DrawBase {
 ...
 public:
  ...
  TCanvas* drawYieldsCascade( const std::string& treeName, const std::string& weightVarName, std::vector< std::pair<std::string,std::string> > cuts, const std::string& saveName );
