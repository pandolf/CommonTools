...
class DrawBase {
 ...
 public:
  ...
  TCanvas* drawHisto_fromTree( const std::string& treeName, const std::string& varName, const std::string& selection, int nBins, Double_t* bins,         const std::string& name, const std::string& axisName, const std::string& units="", const std::string& instanceName="Entries", bool log_aussi=false, int legendQuadrant=1, const std::string& flags="", const std::string& labelText="", bool add_jetAlgoText=false );
  TCanvas* drawYieldsCascade( const std::string& treeName, const std::string& weightVarName, std::vector< std::pair<std::string,std::string> > cuts_and_names, const std::string& saveName );
